...
package org.digitalcampus.oppia.monitor.task;
...
import org.digitalcampus.oppia.monitor.listener.SubmitListener;
import org.digitalcampus.oppia.monitor.model.User;
import org.digitalcampus.oppia.monitor.utils.HTTPConnectionUtils;
...
public class LoginTask extends AsyncTask<Payload, Object, Payload> {
	...
	protected Payload doInBackground(Payload... params) {
		...
		String url = prefs.getString("prefServer", ctx.getString(R.string.prefServerDefault)) + OppiaMonitor.LOGIN_PATH;
